...
#[derive(Debug)]
pub struct GitWorkflowProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GitWorkflowProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GitWorkflow processing");
    
    let mut processor = GitWorkflowProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GitWorkflowProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GitWorkflowProcessor::new(false);
